...
import website.treelink.member.model.dao.RoleDao;
...
public class CustomDynamicAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
	...
	public AuthorizationDecision check(Supplier<? extends @Nullable Authentication> authentication2, 
        ...
        Role.UserNoUrl userNoUrl = new Role.UserNoUrl(userNo, requestUrl);
        if(roleDao.selectUrlIsAllowed(userNoUrl)==1) {
        	isAllowed = true;
        }
